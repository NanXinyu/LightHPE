...
class MPII:
    ...
    def __init__(self, data_split):
        ...
        self.img_dir = osp.join('/root/repo/nanxinyu/2DHPE/data/mpii/images')
        self.train_annot_path = osp.join('/root/repo/nanxinyu/2DHPE/data/mpii/annot_coco/train.json')
        self.joint_num = 16
