...
class Human36M:
    def __init__(self, data_split):
        ...
        self.img_dir = osp.join('/root/repo/nanxinyu/dataset/Human36M/images')
        self.annot_path = osp.join('/root/repo/nanxinyu/dataset/Human36M/annotations')
        ...
        self.parents = (0, 1, 2, 3, 0, 4, 5, 6, 0, 7, 17, 8, 7, 11, 12, 14, 13, 7, 14, 15, 16, 16)
    ...
    def evaluate(self, img_preds, cam_preds, result_dir):
        
        print('Evaluation start...')
        gts = self.data
        assert len(gts) == len(img_preds) == len(cam_preds)
        sample_num = len(gts)
